          ...
          >
            ...
            <div className="flex justify-center">
              <button
                ...
                disabled={!isChecked || isSubmitting || !!approvalId}
                className={`w-full py-3 rounded-lg kanit-semibold text-white ${
                  !isChecked || isSubmitting || !!approvalId
                    ? "bg-gray-300 cursor-not-allowed"
                    : "bg-seagreen cursor-pointer"
                }`}
              >
