  ...
  const faqCategories = [
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question:
            "ฉันสามารถระบุสิ่งอำนวยความสะดวกในที่ทำงานที่ต้องการได้หรือไม่?",
          answer:
  ...
  return (
    <div className="h-screen">
      ...
      <div className="ml-6 mr-6">
        <div className="mt-4 kanit-bold text-2xl">คำถามที่พบบ่อย</div>

        <Box mb={32}>
          <Text size="lg" mb={24} className="kanit-regular">
            ค้นหาคำตอบสำหรับคำถามทั่วไปเกี่ยวกับการใช้งานแพลตฟอร์มหางานของเรา
            หากคุณไม่พบสิ่งที่กำลังค้นหา กรุณาติดต่อทีมสนับสนุนของเรา
          </Text>
        ...
        <Paper withBorder p={24} mt={48} radius="md">
          <div className="kanit-regular text-xl">มีคำถามเพิ่มเติม?</div>
          <Text mb={16} className="kanit-regular">
          ...
          <Group className="mb-3">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="rounded-lg bg-seagreen p-3 text-white kanit-regular transition-colors duration-500 transform "
            >
              ติดต่อฝ่ายสนับสนุน
            </motion.button>
          </Group>
